    ...
    <div className="flex border p-5 flex-col rounded bg-white">
      <div className="flex gap-10 pb-3">
        <div className="flex flex-col w-full">
          <p className="text-lg mb-2 font-semibold">Riwayat Sewa</p>
          <div className="flex border rounded border-purple-600 p-3 flex-col mb-5">
            ...
            <div className="flex justify-between border-b pb-2">
              <div className="flex flex-col ">
                <div className="flex gap-2 items-center">
                  <p className="font-semibold">Order Id : 84734</p>
                  <p>|</p>
                  <p className="text-red-700 bg-red-100 rounded py-1 px-3">Berakhir</p>
                </div>
                <div className="flex">
                  <p>Sewa Berakhir : 16 Februari 2023</p>
                </div>
